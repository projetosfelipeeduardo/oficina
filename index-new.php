        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="ordem.php"><i class="fa fa-edit"></i> <span class="nav-label">Abrir OS</span></a>
                    </li>

                    <li>
                        <a href="fecha.php"><i class="fa fa-lock"></i> <span class="nav-label">Fechar da OS</span></a>
                    </li>
