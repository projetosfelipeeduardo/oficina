                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-user"></i> Cadastro de Veículos - Inclusão
                            </button>
                        </div>

                        <div class="ibox-content">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="veiculosg.php">
                                    ...
                                    <!--div class="col-lg-6"-->
                                            ...
                                            <div class="col-md-6">
                                              <select name="cdclie" id="cdclie" maxlength="55" style="width:350px;">
                                                <?php for($i=0;$i < count($aClie);$i++) { ?>
                                                  <!--option><?php echo str_pad($aCond[$i]["decond"],14,"0",STR_PAD_LEFT) ;?></option-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input id="deplac" name="deplac" value="" type="text" placeholder="XPO1234" class="form-control" autofocus maxlength = "07">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input id="deanof" name="deanof" value="" type="text" placeholder="2016" class="form-control" maxlength = "04">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input id="deanom" name="deanom" value="" type="text" placeholder="2016" class="form-control" maxlength = "04">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="demarc" name="demarc" value="" type="text" placeholder="GM" class="form-control" maxlength = "30">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="demode" name="demode" value="" type="text" placeholder="Monza" class="form-control" maxlength = "30">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="decor" name="decor" value="" type="text" placeholder="Verde" class="form-control" maxlength = "30">
                                            </div>
                                        </div>
