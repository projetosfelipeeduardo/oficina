...
<body>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="dtpedi" name="dtpedi" value="<?php echo $datap;?>" type="date" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="vlpedi" name="vlpedi" value="0,00" type="text" placeholder="" class="form-control" maxlength = "15">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="decont" name="decont" value="" type="text" placeholder="" class="form-control" maxlength = "100">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="dtentr" name="dtentr" value="" type="date" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="vlpago" name="vlpago" value="0,00" type="text" placeholder="" class="form-control" maxlength = "15">
                                            </div>
                                        </div>
    ...
    <script language="javascript">
        ...
        function calcula(){
            ...
            document.getElementById('vlpedi').value = formatNumber(nt);
