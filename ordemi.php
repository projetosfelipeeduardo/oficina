...
<body>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-user"></i> Cadastro de OS - Inclusão
                            </button>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="veplac" name="veplac" value="" type="text" placeholder="" class="form-control" maxlength = "7">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="textinput">Marca do Veículo</label>
                                            <div class="col-md-4">
                                                <input id="vemarc" name="vemarc" value="" type="text" placeholder="" class="form-control" maxlength = "50">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="textinput">Modelo do Veículo</label>
                                            <div class="col-md-4">
                                                <input id="vemode" name="vemode" value="" type="text" placeholder="" class="form-control" maxlength = "50">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="textinput">Cor do Veículo</label>
                                            <div class="col-md-4">
                                                <input id="vecorv" name="vecorv" value="" type="text" placeholder="" class="form-control" maxlength = "50">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="textinput">Ano Fabricação</label>
                                            <div class="col-md-2">
                                                <input id="veanof" name="veanof" value="" type="text" placeholder="" class="form-control" maxlength = "04">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="textinput">Ano Modelo</label>
                                            <div class="col-md-2">
                                                <input id="veanom" name="veanom" value="" type="text" placeholder="" class="form-control" maxlength = "04">
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
      function filter (t, o){
        var combo = document.getElementById(o);
        ...
        for (i = 0; i < combo.length; i = i + 1) {
            ...
            posicao=texto.indexOf(t);
            if (posicao>=0){
                //alert(t+' --> '+texto+' : '+posicao);
                break;
            }
