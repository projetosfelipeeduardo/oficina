                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-user"></i> Cadastro de Fornecedores - Inclusão
                            </button>
                        </div>

                        <div class="ibox-content">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="fornecedoresg.php">
                                ...
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="cdforn" name="cdforn" type="text" value="" placeholder="" class="form-control" maxlength = "14" autofocus required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 ">
                                                <input id="deforn" name="deforn" value="" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                            </div>
                                        </div>
