<?php
    ...
    $aClie= ConsultarDados("", "", "","select * from m_clientes order by cdclie");
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                    class="fa fa-user"></i> Cadastro de Ordem de Serviços - Inclusão
                        </button>
                    </div>

                    <div class="ibox-content">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="ordemg.php">
                            <div>
                                <center>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                          <select name="cdclie" id="cdclie" maxlength="55" style="width:350px;">
                                    ...
                                    <div class="form-group">
                                        <?php $data = date('Y-m-d');?>
                                        <label class="col-md-2 control-label" for="textinput">Emissão</label>
                                        <div class="col-md-2">
                                            <input id="dtemis" name="dtemis" value="<?php echo $data; ?>" type="date" placeholder="" class="form-control" maxlength = "10" autofocus>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Número da Nota</label>
                                        <div class="col-md-2">
                                            <input id="nrnota" name="nrnota" value="" type="text" placeholder="" class="form-control" maxlength = "15">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Valor dos Serviços</label>
                                        <div class="col-md-2">
                                            <input id="vlserv" name="vlserv" value="0,00" type="text" placeholder="" class="form-control" maxlength = "15">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Valor das Peças</label>
                                        <div class="col-md-2">
                                            <input id="vlpeca" name="vlpeca" value="0,00" type="text" placeholder="" class="form-control" maxlength = "15">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Valor dos Tributos</label>
                                        <div class="col-md-2">
                                            <input id="vlimpo" name="vlimpo" value="0,00" type="text" placeholder="" class="form-control" maxlength = "15">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Outros Valores</label>
                                        <div class="col-md-2">
                                            <input id="vloutr" name="vloutr" value="0,00" type="text" placeholder="" class="form-control" maxlength = "15">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Valor Total</label>
                                        <div class="col-md-2">
                                            <input id="vltota" name="vltota" value="0,00" type="text" placeholder="" class="form-control" maxlength = "15">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Cancelado</label>
                                        <div class="col-md-2">
                                            <select name="flcanc" id="flcanc">
                                                <option>Sim</option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Pago</label>
                                        <div class="col-md-2">
                                            <select name="flpago" id="flpago">
                                                <option>Sim</option>
                                                <option selected= "selected">Não</option>
                                            </select>
                                        </div>
