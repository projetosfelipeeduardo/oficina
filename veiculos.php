<?php
    ...
    // usuarios
    $aVeic= ConsultarDados("", "", "","SELECT v.cdveic, v.deplac, v.deanof, v.deanom, v.demarc, v.demode, v.decor, c.cdclie, v.flativ, v.dtcada, v.dtulti, c.declie FROM m_veiculos v, m_clientes c WHERE left(v.cdclie,11) = left(c.cdclie,11)");
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-user"></i> Cadastro de Veículos
                            </button>
                        </div>

                        <div class="ibox-content">
                            <div class="pull-left">
                                <a onclick="#" href="veiculosi.php" class="btn btn-warning ">Incluir</a>
                            </div>
                            <br>
                            <br>
                            <br>
