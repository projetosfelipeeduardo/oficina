                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-user"></i> Minha Senha - <small>Atualização</small>
                            </button>
                        </div>
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="minhasenhag.php">
                                ...
                                <!--input type=hidden name="cdusua" value="<?php echo $cdusua; ?>"-->
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="deusua" name="deusua" value="<?php echo $deusua; ?>" type="text" placeholder="" class="form-control" maxlength = "100" readonly="">
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    <label class="col-md-2 control-label" for="textinput">Nova Senha</label>
                                    <div class="col-md-4">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="desenh1" name="desenh1" type="password" placeholder="" class="form-control" maxlength = "100" required="">
                                    </div>
                                  </div>
